...
alf_fortran = pi/2 - data(10:end,6);
u_forftran = data(1:3:end,fieldNum+6);
u_forftran_p = sqrt(data(10:end,polar_couple(1)+6).^2 + data(10:end,polar_couple(2)+6).^2);
...
f_pol = figure();
polarplot(alf_fortran, u_forftran_p, alf_Sphase, u_Sphase, '--');
